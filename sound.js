const allWords = ['penguin', 'shuttlecock', 'whale']; // 更新后的单词列表
let correctOrder = [];
let currentOrder = [];
let totalAttempts = 0;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const sounds = {
        penguin: new Audio('https://dict.youdao.com/dictvoice?audio=penguin&type=2'),
        shuttlecock: new Audio('https://ssl.gstatic.com/dictionary/static/sounds/20200429/shuttlecock--_gb_1.mp3'),
        whale: new Audio('https://ssl.gstatic.com/dictionary/static/sounds/20200429/whale--_gb_1.mp3')
    };
    ...
    nextBtn.addEventListener('click', () => {
        // 简单跳转
        window.location.href = 'sound2.html'; });
